                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <label for="">Mật khẩu
                                                ...
                                                <span class="text-danger" id="error-password"
                                                    style="font-style: italic;">(*) {{ $errors->first('password')
                                                    }}</span>
                                                <script>
                                                    function timedOut() {
                                        ...
                                        <div class="form-group">
                                            <label for="">Xác nhận mật khẩu<span class="text-danger" id="match-password"
                                                    style="font-style: italic;"></span></label>
                                            <input type="password" name="password_confirmation" class="form-control"
                                                id="password_confirmation" placeholder="Xác nhận mật khẩu" required
                                                onchange="checkMatch();">
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <div class="custom-file">
                                                    <input type="checkbox" name="gender" id="gender" checked
                                                        data-bootstrap-switch data-off-color="success"
                            ...
                            <table id="tableUser" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($item->image=='')
                                            <img src="{{ asset('images/system/user1.png') }}" alt="IMAGE" srcset=""
                                                width="32">
                                            @else
                                            <img src="{{ asset('images/user/'.$item->image) }}" alt="IMAGE" srcset=""
                                                width="32">
                                            @endif
                                        </td>
